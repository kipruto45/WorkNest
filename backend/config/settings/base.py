...
env = environ.Env(
    ...
    TEAM_ALLOW_ADMIN_ROLE_INVITE_LINKS=(bool, False),
    TEAM_ALLOW_MANAGER_ROLE_INVITE_LINKS=(bool, True),
    TEAM_ALLOW_MANAGER_ROLE_EMAIL_INVITES=(bool, False),
    TEAM_ALLOW_MANAGER_ANNOUNCEMENTS=(bool, True),
    LOGO_URL=(str, ""),
    ...
    CELCOM_API_KEY=(str, ""),
    CELCOM_PARTNER_ID=(str, ""),
    CELCOM_SHORTCODE=(str, ""),
    CELCOM_BASE_URL=(str, ""),
    CELCOM_PASS_TYPE=(str, "plain"),
...
TEAM_ALLOW_ADMIN_ROLE_INVITE_LINKS = env("TEAM_ALLOW_ADMIN_ROLE_INVITE_LINKS")
TEAM_ALLOW_MANAGER_ROLE_INVITE_LINKS = env("TEAM_ALLOW_MANAGER_ROLE_INVITE_LINKS")
TEAM_ALLOW_MANAGER_ROLE_EMAIL_INVITES = env("TEAM_ALLOW_MANAGER_ROLE_EMAIL_INVITES")
TEAM_ALLOW_MANAGER_ANNOUNCEMENTS = env("TEAM_ALLOW_MANAGER_ANNOUNCEMENTS")
...
CELCOM_API_KEY = env("CELCOM_API_KEY")
CELCOM_PARTNER_ID = env("CELCOM_PARTNER_ID")
CELCOM_SHORTCODE = env("CELCOM_SHORTCODE")
CELCOM_BASE_URL = env("CELCOM_BASE_URL")
CELCOM_PASS_TYPE = env("CELCOM_PASS_TYPE", default="plain")
