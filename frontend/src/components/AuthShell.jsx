...
export default function AuthShell({ title, subtitle, footer, children }) {
  return (
    <div className="app-shell relative flex min-h-dvh items-center justify-center overflow-hidden px-4 py-4 lg:py-6">
      <div className="ambient-orb -left-12 top-24 h-48 w-48 bg-emerald-300/25" />
      <div className="ambient-orb right-0 top-8 h-60 w-60 bg-teal-300/15" />
      <div className="ambient-orb bottom-8 left-1/3 h-40 w-40 bg-lime-300/15" />
      ...
      <div className="relative grid w-full max-w-5xl gap-6 lg:grid-cols-[1.02fr,0.98fr]">
        <div className="hero-panel hidden min-h-[460px] flex-col justify-between lg:flex">
          <div>
            ...
            <h1 className="mt-4 font-display text-[2.75rem] font-bold leading-tight text-emerald-950">
          ...
          <div className="grid gap-4">
            <div className="spotlight-panel">
              <div className="relative z-10">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-50/70">Presentation edge</p>
        ...
        <div className="page-shell fade-in w-full px-5 py-6 md:px-7 md:py-7">
          <AppLogo
            ...
            titleClassName="text-sm font-semibold text-emerald-700"
          />
          <div className="mt-6">
            <h2 className="font-display text-2xl font-bold text-emerald-950 md:text-3xl">{title}</h2>
